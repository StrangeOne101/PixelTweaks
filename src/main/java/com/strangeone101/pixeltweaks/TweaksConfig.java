...
public class TweaksConfig {
    ...
    static {
        Pair<TweaksConfig, ModConfigSpec> pair =
                new ModConfigSpec.Builder().configure(builder -> new TweaksConfig(builder, ModConfig.Type.SERVER));

        //Store the resulting values
        CONFIG = pair.getLeft();
        SERVER_SPEC = pair.getRight();

        Pair<TweaksConfig, ModConfigSpec> pair2 =
                new ModConfigSpec.Builder().configure(builder -> new TweaksConfig(builder, ModConfig.Type.CLIENT));
