...
public class TaskListener {
    ...
    public TaskListener() {
        Pixelmon.EVENT_BUS.addListener(this::betterOnCatch);
        Pixelmon.EVENT_BUS.addListener(this::onDefeatPokemon);
    }
    ...
    public void onCatch(CaptureEvent.SuccessfulCapture event) {
        ...
        pokemon.setBall(event.getPokeBall().getBallType()); //Update the ball type as it isn't updated in this event
