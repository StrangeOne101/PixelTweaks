...
public class BreedTask extends Task {
    ...
    public void readData(CompoundTag nbt, HolderLookup.Provider provider) {
        ...
        this.parent1 = parent1Specs.isEmpty() ? null : PokemonSpecificationProxy.create(parent1Specs).get();
        String parent2Specs = nbt.getString("parent2");
        this.parent2 = parent2Specs.isEmpty() ? null : PokemonSpecificationProxy.create(parent2Specs).get();
